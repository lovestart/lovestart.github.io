 ...
 * @version 1.0
 */
public class ZhuXueGroupAuthInfoServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		if(!"200".equals(map.get("code").toString())){
			...
			redirectUrl = ConstantsUtil.getConstantsUtil().getZxt_detail_url()+"?groupId="+groupId+"&userId="+userId+"&openId="+openId+"&shareUserId="+shareUserId;
		}
