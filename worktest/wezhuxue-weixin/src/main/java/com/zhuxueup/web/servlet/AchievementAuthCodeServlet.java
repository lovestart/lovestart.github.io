 ...
 * @version 1.0
 */
public class AchievementAuthCodeServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		String redirectUrl = ConstantsUtil.getConstantsUtil().getAchieve_authInfo_url();
		redirectUrl = redirectUrl.replace("USERID", userId);
