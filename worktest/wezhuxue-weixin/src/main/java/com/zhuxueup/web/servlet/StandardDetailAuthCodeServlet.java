 ...
 * @version 1.0
 */
public class StandardDetailAuthCodeServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		String redirectUrl = ConstantsUtil.getConstantsUtil().getSbxq_authInfo_url();
		redirectUrl = redirectUrl.replace("LOANID", loanId)
