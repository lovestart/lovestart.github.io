 ...
 * @version 1.0
 */
public class ZhuXueGroupAuthCodeServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		String redirectUrl = ConstantsUtil.getConstantsUtil().getZxt_authInfo_url();
		redirectUrl = redirectUrl.replace("GROUPID", groupId)
				.replace("SHAREUSERID", shareUserId);
