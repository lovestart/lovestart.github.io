 ...
 * @version 1.0
 */
public class JzDetailAuthCodeServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		String redirectUrl = ConstantsUtil.getConstantsUtil().getJzxq_authInfo_url();
		redirectUrl = redirectUrl.replace("JOBID", jobId);
